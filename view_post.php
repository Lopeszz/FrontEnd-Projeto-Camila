   ...
   if (isset($_POST['open_edit_box'])) {
      ...
      <section class="comment-edit-form">
         ...
         <form action="" method="POST">
            ...
            <div class="inline-option-btn" onclick="window.location.href = 'view_post.php?post_id=<?= $get_id; ?>';">cancel
               edit</div>
         </form>
      </section>
      <?php
            ...
            while ($fetch_posts = $select_posts->fetch(PDO::FETCH_ASSOC)) {
               ...
               <form class="box" method="post">
                  ...
                  <?php if (!empty($file_name)) { ?>
                     <a href="uploaded_file/<?= $file_name; ?>" class="download-link" download>Download File</a>
                  <?php } ?>
                  <div class="icons">
   ...
   <section class="comments-container">
      ...
      if ($user_id != '') {
         ...
         <form action="" method="post" class="add-comment">
            ...
            <p class="user"><i class="fas fa-user"></i><a href="update.php">
                  <?= $fetch_profile['name']; ?>
               </a></p>
            ...
            while ($fetch_comments = $select_comments->fetch(PDO::FETCH_ASSOC)) {
               ...
               <div class="show-comments" style="<?php if ($fetch_comments['user_id'] == $user_id) {
                  ...
                  <div class="comment-box"
                     style="<?php if ($fetch_comments['user_id'] == $user_id) {
